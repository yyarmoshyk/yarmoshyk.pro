---
layout: page
title: Post-Audit Security Remediation (SecOps)
description: "Pre- and post-audit cloud security remediation for AWS and GCP — turn a security audit report into fixed findings and a cloud setup that's actually ready for ISO 27001 and SOC 2."
permalink: /secops/
background: grey
---
...
<div class="text-center" style="margin-top:40px;">
  <a class="btn btn-primary btn-xl js-scroll-trigger" href="/#contact">Get help with remediation</a>
</div>
