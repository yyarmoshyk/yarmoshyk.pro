...
<div class="col-lg-10 offset-lg-1 text-center">
	<h2 class="section-heading text-uppercase">Cloud Migration</h2>
	<p class="lead">Migrate into or between AWS and GCP without the operational surprises.</p>
</div>
...
<div class="text-center" style="margin-top:40px;">
  <a class="btn btn-primary btn-xl js-scroll-trigger" href="/#contact">Plan your migration</a>
</div>
