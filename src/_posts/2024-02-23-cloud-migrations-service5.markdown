...
type: service
---
This is totally a custom quote that depends on your applications.<br>
This project includes the scope of Well Architected Cloud platform and consists of the following phases:<br>
1. **Assessment/discovery** - at this stage we need to understand the current state or your application, it's architecture, daily routines, amount of data to be transferred and external dependencies. We build the plan and technical roadmap based on the findings. At this stage we have high level estimate of the efforts and the approximate total cost of ownership for the target cloud environment.
