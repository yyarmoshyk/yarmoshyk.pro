...
This package includes standard scope and can be extended upon your needs with a custom quote.

Our goal is to build secure, cost efficient and easy manageable environment for your business.

The scope includes but is not limited to the following:
1. Multiaccount Landing zone setup
1. Configure SSO for your AWS organisation with optional integration to the existing SSO system like Okta.
1. GitOps driven Infrastructure as a Code framework built with [terraform](https://www.terraform.io/) and [terragrunt](https://terragrunt.gruntwork.io/) to manage your cloud resources efficiently.
1. Balanced docker container orchestration with AWS ECS or AWS Managed Kubernetes Service (EKS).
...
1. Control Tower, Web Application firewall and many more buzzwords from AWS world.
